...
//         if (inventoryStatus.AvailableQuantity < quantity)
//         {
//             return new ProductOrderResultDto
//             {
//                 Success = false,
//                 Message = $"الكمية المطلوبة غير متوفرة. المتوفر: {inventoryStatus.AvailableQuantity}",
//                 AvailableQuantity = inventoryStatus.AvailableQuantity
//             };
//         }

//         // حساب السعر مع الخصومات
//         var finalPrice = await _pricingContext.CalculatePriceAsync(product.SellingPrice, customerName);
...
//             AppliedDiscount = product.SellingPrice - finalPrice
//         };
//     }
...
//     {
//         var invoice = await _salesInvoiceService.GetSalesInvoiceAsync(salesInvoiceId);
//         if (invoice == null)
//         {
...
//             TotalValue = inventoryReport.Sum(p => p.TotalValue),
//             LowStockItems = inventoryReport.Count(p => p.AvailableQuantity <= p.MinStockLevel),
//             OutOfStockItems = inventoryReport.Count(p => p.AvailableQuantity == 0)
//         };
//     }
